const ArrayUtil = require('./tools.js').ArrayUtil;
const Uint8ArrayUtil = require('./tools.js').Uint8ArrayUtil

class sACNPacket {
  constructor(universe, priority){
    ...
    this.name = Uint8ArrayUtil.fromText("NodeSACN-" + this.universe);
...
module.exports.sACNPacket = sACNPacket;
